...
fun abrirAppContactos(context : Context){
    ...
    if (intent.resolveActivity(context.packageManager) != null){
        ...
        Toast.makeText(context, "No hay aplicacion para abrir contactos",
...
fun agregarContacto(context: Context, nombre: String, telefono: String){
    val eps = ArrayList<ContentProviderOperation>().apply{
        add(
    ...
    try {
        context.contentResolver.applyBatch(ContactsContract.AUTHORITY, eps)
    }catch (e: Exception){
        e.printStackTrace()
    }
}
